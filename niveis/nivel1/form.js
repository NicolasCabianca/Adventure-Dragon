class Form {
  ...
  definePosicao() {
    ...
    this.buttonReset.position(width / 5 - 260, height / 1.20)
    ...
    this.inputSenhaDEV.position(width / 5 - 260, height / 1.20 + 25)
  }
  definirEstilo() {
    ...
    console.log("trocando de classe")
  ...
  definirClique() {
    // this.button5.mouseClicked(()=>{
    //  if(this.button5.mouseClicked){
    //    !this.esterEgg1.hide()
    //    !this.esterEgg2.hide()
    //    !this.esterEgg3.hide()
    //    !this.esterEgg4.hide()
