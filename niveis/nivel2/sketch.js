...
function preload() {
  ...
  EspFImg = loadImage("Img/espadaDFogo.png")
  AsDImg = loadImage("Img/adaga2.png")
  BImg = loadImage("Img/Bt.png")
  MgImg = loadImage("Img/Mg.png")
...
function setup() {
  ...
  sprite1.addAnimation("ataqueE", cavAtaqueF)
  sprite1.scale = 2;
  ...
  sprite2.addAnimation("ataqueE",elfoNAtaqueS)
  sprite2.scale = 2;
  ...
  sprite3.addAnimation("ataqueE",centAtaqueB)
  sprite3.scale = 2;
  ...
  sprite4.addAnimation("ataqueE", minoAtaqueM);
  sprite4.scale = 2;
